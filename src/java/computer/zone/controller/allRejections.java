 ...
 * @author RTAP4
 */
@WebServlet(name = "allRejections", urlPatterns = {"/allRejections"})
public class allRejections extends HttpServlet {
  ...
  PrintWriter n=response.getWriter();
   //response.sendRedirect("mainPage.jsp?menuPage=NewEntry.jsp&view=AdminPage.jsp?error=User Name has been used by onther user");
      response.sendRedirect("mainPage.jsp?view=ApproverReject.jsp?requisitionId="+rin);
    }
